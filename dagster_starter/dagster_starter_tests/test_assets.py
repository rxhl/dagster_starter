...
# dagster_starter = importlib.import_module("dagster-starter")

from dagster_starter.assets import (
...
def test_smoke():
    ...
    github_api.get_repo(REPO_NAME).get_stargazers_with_dates.return_value = [
        MagicMock(
    ...
    assert (
        result.output_for_node("github_stars_notebook_gist")
        == "https://gist.github.com/test_id"
    )
